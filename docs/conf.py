...
htmlhelp_basename = 'OpenLibertyCollectionDoc'
...
latex_documents = [
    (master_doc, 'OpenLibertyCollection.tex', 'Open Liberty Ansible Collection Documentation',
     'Red Hat, Inc.', 'manual'),
]
...
man_pages = [
    (master_doc, 'openlibertycollection', 'Open Liberty Ansible Collection Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OpenLibertyCollection', 'Open Liberty Ansible Collection Documentation',
     author, 'OpenLibertyCollection', 'Ansible collection to install and manage Open Liberty.',
     'Miscellaneous'),
]
